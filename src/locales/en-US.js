export default {
  ...
  transactionResults: {
    ...
    globalPointsSettings: 'Global Points Settings',
    totalSpentPoints: 'Total Spent Points',
    enterSpentPoints: 'Enter spent points',
    spentPointsDescription: 'Set the total points consumed during this period',
    resetAll: 'Reset All',
    dailyPointsDetails: 'Daily Points Details',
    clickToAdjustPoints: 'Click adjust button to modify points earned on specific dates',
    date: 'Date',
    ...
    calculateStatsFirst: 'Please calculate transaction statistics first to get points data',
    pointsCalculationExplanation: 'Points Calculation Explanation',
    pointsCalculationRule1: 'Points are calculated based on Alpha token inflow: points = floor(log2(Inflow USD + BSC Bonus))',
    pointsCalculationRule2: 'Alpha tokens on BSC chain get additional equal bonus rewards',
    pointsCalculationRule3: 'You can manually adjust daily points earned to reflect actual situations',
    pointsCalculationRule4: 'Final Points = Sum of adjusted daily points - Total spent points',
    // Points adjustment related messages
    adjustPointsPrompt: 'Adjust points earned on {date} (current: {currentPoints}):',
    adjustDailyPoints: 'Adjust Daily Points',
    invalidPointsInput: 'Please enter a valid non-negative number',
    ...
    globalSpentPointsSaved: 'Global spent points saved',
    resetAllConfirm: 'Are you sure you want to reset all points adjustments? This will clear all manual adjustments and global settings.',
