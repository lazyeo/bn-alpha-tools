export default {
  ...
  transactionResults: {
    ...
    currentBalance: '当前余额',
    activeDays: '活跃天数',
    globalPointsSettings: '全局积分设置',
    totalSpentPoints: '总消耗积分',
    enterSpentPoints: '输入消耗的积分',
    spentPointsDescription: '设置在此期间总共消耗的积分数量',
    resetAll: '重置全部',
    dailyPointsDetails: '每日积分明细',
    clickToAdjustPoints: '点击调整按钮可修改特定日期的积分获得量',
    date: '日期',
    originalPoints: '原始积分',
    adjustedPoints: '调整后积分',
    ...
    adjusted: '已调整',
    noPointsData: '暂无积分数据',
    calculateStatsFirst: '请先计算交易统计以获取积分数据',
    pointsCalculationExplanation: '积分计算说明',
    pointsCalculationRule1: '积分基于Alpha代币流入金额计算：points = floor(log2(流入USD + BSC奖励))',
    pointsCalculationRule2: 'BSC链上的Alpha代币流入可获得等额奖励加成',
    pointsCalculationRule3: '您可以手动调整每日积分获得量以反映实际情况',
    pointsCalculationRule4: '最终积分 = 调整后的每日积分总和 - 总消耗积分',
    // 积分调整相关消息
    adjustPointsPrompt: '调整 {date} 的积分获得量（当前：{currentPoints}）：',
    adjustDailyPoints: '调整每日积分',
    invalidPointsInput: '请输入有效的非负数字',
    pointsAdjusted: '已将 {date} 的积分调整为 {points}',
    resetPointsConfirm: '确定要重置 {date} 的积分调整吗？',
    resetPoints: '重置积分',
    pointsReset: '已重置 {date} 的积分调整',
    globalSpentPointsSaved: '全局消耗积分已保存',
    resetAllConfirm: '确定要重置所有积分调整吗？这将清除所有手动调整和全局设置。',
